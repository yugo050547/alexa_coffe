...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'コーヒーショップへようこそ';
        const reprompt = 'なににしますか。はよはよ'
...
const OrderIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let atribute = handlerInput.attributesManager.getSessionAttributes();
        
        let slots = handlerInput.requestEnvelope.request.intent.slots
        let menu = slots.menu.value || atribute.menu;
        let amount = slots.amount.value || atribute.amount;
        
        if ( menu === undefined ){
            atribute.amount = amount;
            handlerInput.attributesManager.setSessionAttributes(atribute);
